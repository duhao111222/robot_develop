...
bool status_insterfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("status_insterfaces.msg._system_status", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("SystemStatus", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  status_insterfaces__msg__SystemStatus * ros_message = _ros_message;
  {  // stamp
...
PyObject * status_insterfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("status_insterfaces.msg._system_status");
