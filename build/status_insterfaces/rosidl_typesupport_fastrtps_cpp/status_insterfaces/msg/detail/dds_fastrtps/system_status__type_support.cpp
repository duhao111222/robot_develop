...
#include "status_insterfaces/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = status_insterfaces::msg::SystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const status_insterfaces::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<status_insterfaces::msg::SystemStatus *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_status_insterfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<status_insterfaces::msg::SystemStatus>()
{
  return &status_insterfaces::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
