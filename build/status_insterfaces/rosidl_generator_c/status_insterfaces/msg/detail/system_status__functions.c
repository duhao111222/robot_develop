...
status_insterfaces__msg__SystemStatus__init(status_insterfaces__msg__SystemStatus * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    status_insterfaces__msg__SystemStatus__fini(msg);
    return false;
  }
  // host_name
...
status_insterfaces__msg__SystemStatus__create(void)
{
  ...
  status_insterfaces__msg__SystemStatus * msg = (status_insterfaces__msg__SystemStatus *)allocator.allocate(sizeof(status_insterfaces__msg__SystemStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(status_insterfaces__msg__SystemStatus));
  bool success = status_insterfaces__msg__SystemStatus__init(msg);
  if (!success) {
...
status_insterfaces__msg__SystemStatus__Sequence__init(status_insterfaces__msg__SystemStatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  status_insterfaces__msg__SystemStatus * data = NULL;

  if (size) {
    data = (status_insterfaces__msg__SystemStatus *)allocator.zero_allocate(size, sizeof(status_insterfaces__msg__SystemStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = status_insterfaces__msg__SystemStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        status_insterfaces__msg__SystemStatus__fini(&data[i - 1]);
      }
...
status_insterfaces__msg__SystemStatus__Sequence__fini(status_insterfaces__msg__SystemStatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      status_insterfaces__msg__SystemStatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  status_insterfaces__msg__SystemStatus__Sequence * array = (status_insterfaces__msg__SystemStatus__Sequence *)allocator.allocate(sizeof(status_insterfaces__msg__SystemStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = status_insterfaces__msg__SystemStatus__Sequence__init(array, size);
  if (!success) {
...
status_insterfaces__msg__SystemStatus__Sequence__destroy(status_insterfaces__msg__SystemStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    status_insterfaces__msg__SystemStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
status_insterfaces__msg__SystemStatus__Sequence__are_equal(const status_insterfaces__msg__SystemStatus__Sequence * lhs, const status_insterfaces__msg__SystemStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!status_insterfaces__msg__SystemStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  status_insterfaces__msg__SystemStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(status_insterfaces__msg__SystemStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    status_insterfaces__msg__SystemStatus * data =
      (status_insterfaces__msg__SystemStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!status_insterfaces__msg__SystemStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          status_insterfaces__msg__SystemStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!status_insterfaces__msg__SystemStatus__copy(
